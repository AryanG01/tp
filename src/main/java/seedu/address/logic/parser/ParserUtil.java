...
public class ParserUtil {
    ...
    /**
     * Parses a {@code String date} into a {@code BookingDate}.
     * Leading and trailing whitespaces will be trimmed.
     *
     * @param date The date string to be parsed into a BookingDate object.
     * @return A BookingDate object representing the parsed date.
     * @throws ParseException if the given {@code date} is invalid.
     */
    public static BookingDate parseBookingDate(String date) throws ParseException {
        requireNonNull(date);
        String trimmedDate = date.trim();
        if (!BookingDate.isValidDate(trimmedDate)) {
            throw new ParseException(Email.MESSAGE_CONSTRAINTS);
        }
        return new BookingDate(trimmedDate);
    }
