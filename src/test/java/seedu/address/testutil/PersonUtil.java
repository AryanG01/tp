...
public class PersonUtil {
    ...
    public static String getPersonDetails(Booking booking) {
        ...
        sb.append(PREFIX_ADDRESS + booking.getAddress().value + " ");
        sb.append(PREFIX_START_DATE + booking.getStartDate().toString() + " ");
        sb.append(PREFIX_END_DATE + booking.getEndDate().toString() + " ");
    ...
    public static String getEditPersonDescriptorDetails(EditRoomDescriptor descriptor) {
        ...
        descriptor.getStartDate().ifPresent(startDate -> sb.append(PREFIX_START_DATE).append(startDate.toString())
                .append(" "));
        descriptor.getAddress().ifPresent(endDate -> sb.append(PREFIX_END_DATE).append(endDate.toString()).append(" "));
