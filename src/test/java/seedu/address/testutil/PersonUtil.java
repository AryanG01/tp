...
public class PersonUtil {
    ...
    public static String getPersonDetails(Booking booking) {
        ...
        sb.append(PREFIX_DATE + booking.getStartDate().toString() + " ");
        sb.append(PREFIX_DATE + booking.getEndDate().toString() + " ");
    ...
    public static String getEditPersonDescriptorDetails(EditRoomDescriptor descriptor) {
        ...
        descriptor.getStartDate().ifPresent(startDate -> sb.append(PREFIX_DATE).append(startDate.toString())
                .append(" "));
        descriptor.getAddress().ifPresent(endDate -> sb.append(PREFIX_DATE).append(endDate.toString()).append(" "));
