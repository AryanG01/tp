...
public class CommandTestUtil {
    ...
    public static final String VALID_START_AMY = "2019-Oct-15";
    public static final String VALID_END_AMY = "2023-Oct-19";
    public static final String VALID_START_BOB = "2019-Oct-15";
    public static final String VALID_END_BOB = "2023-Oct-19";
    ...
    public static final String START_DESC_AMY = " " + PREFIX_START_DATE + VALID_START_AMY;
    public static final String END_DESC_AMY = " " + PREFIX_END_DATE + VALID_END_AMY;
    public static final String START_DESC_BOB = " " + PREFIX_START_DATE + VALID_START_BOB;
    public static final String END_DESC_BOB = " " + PREFIX_END_DATE + VALID_END_BOB;
    ...
    public static final String INVALID_START_DESC = " " + PREFIX_START_DATE + "2019/13/15"; // using /, integer month
    public static final String INVALID_END_DESC = " " + PREFIX_END_DATE + "2023/13/15"; // using /, integer month
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withRoom(VALID_ROOM_AMY).withName(VALID_NAME_AMY)
                ...
                .withStartDate(VALID_START_AMY).withEndDate(VALID_END_AMY).withTags(VALID_TAG_FRIEND).build();
