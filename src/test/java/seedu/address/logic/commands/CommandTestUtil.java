...
public class CommandTestUtil {
    ...
    public static final String VALID_DATE_AMY = "2019-Oct-15";
    public static final String VALID_DATE_BOB = "2023-Oct-19";
    ...
    public static final String INVALID_DATE_DESC = " " + PREFIX_DATE + "2019/13/15"; // using /, integer month
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withRoom(VALID_ROOM_AMY).withName(VALID_NAME_AMY)
                ...
                .withEndDate(VALID_DATE_AMY).withEndDate(VALID_DATE_AMY).withTags(VALID_TAG_FRIEND).build();
