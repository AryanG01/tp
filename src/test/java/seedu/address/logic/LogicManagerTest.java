...
import static seedu.address.logic.Messages.MESSAGE_INVALID_BOOKING_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, MESSAGE_INVALID_BOOKING_DISPLAYED_INDEX);
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonBookingBookStorage addressBookStorage = new JsonBookingBookStorage(prefPath) {
            @Override
            public void saveBookingBook(ReadOnlyBookingsBook addressBook, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        String addCommand = AddCommand.COMMAND_WORD + ROOM_DESC_AMY + NAME_DESC_AMY + PHONE_DESC_AMY
